...
void gui_init() {
  ...
  SDL_WM_SetCaption("Wirtualna kamera #2", "");
  ...
  if (gui_font==NULL || gui_font_m==NULL)  {
...
void gui_parametry() {
  ...
  Euler fi = kwaternion_powrot_e(obserwator.obrot);
  double d = kamera.d;
  ...
  stringstream oss;
  oss << (kamera.pokaz_wsp_pkt ? "ukryj" : "pokaż") << " współrzędne pkt";
