...
/*
Wymnozenie wierzcholkow sciany przez wspolrzedne punktu 3D
Parametry wejsciowe: sciana - sciana 3D, p - punkt, zwracana jest wynikowa sciana 3D
*/
D3_sciana d3_sciana_pkt_pomnoz(D3_sciana sciana, D3_punkt p) {

  int i;
  for (i=0;i<4;i++) sciana.wierzcholki[i] = d3_pkt_pomnoz(sciana.wierzcholki[i], p);
  return sciana;
